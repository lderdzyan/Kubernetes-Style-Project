...
function UsersList($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let currentPage = 1;
    const perPage = 50;
    const filteredUsers = filterItems(users, searchState);
      ...
      $$renderer3.push(`<div class="p-4 lg:ml-64">`);
      {
        $$renderer3.push("<!--[!-->");
        {
          ...
          Skeleton_1($$renderer3, {
            title: store_get($$store_subs ??= {}, "$t", $format)("user.table.tableTitle"),
            rows: 10
          });
        }
        $$renderer3.push(`<!--]-->`);
...
//# sourceMappingURL=_page.svelte-BLPwazgT.js.map
