...
export declare var CreateScheduleOutput$: StaticStructureSchema;
export declare var DeadLetterConfig$: StaticStructureSchema;
export declare var DeleteScheduleGroupInput$: StaticStructureSchema;
export declare var DeleteScheduleGroupOutput$: StaticStructureSchema;
export declare var DeleteScheduleInput$: StaticStructureSchema;
export declare var DeleteScheduleOutput$: StaticStructureSchema;
export declare var EcsParameters$: StaticStructureSchema;
export declare var EventBridgeParameters$: StaticStructureSchema;
export declare var FlexibleTimeWindow$: StaticStructureSchema;
export declare var GetScheduleGroupInput$: StaticStructureSchema;
...
export declare var ListSchedulesInput$: StaticStructureSchema;
export declare var ListSchedulesOutput$: StaticStructureSchema;
...
export declare var DeleteScheduleGroup$: StaticOperationSchema;
export declare var GetSchedule$: StaticOperationSchema;
export declare var GetScheduleGroup$: StaticOperationSchema;
export declare var ListScheduleGroups$: StaticOperationSchema;
